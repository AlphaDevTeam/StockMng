...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.alphadevs.com.domain.ItemBinCard.class.getName());
            ...
            createCache(cm, com.alphadevs.com.domain.CashBookBalance.class.getName());
            createCache(cm, com.alphadevs.com.domain.CustomerAccount.class.getName());
            createCache(cm, com.alphadevs.com.domain.CustomerAccountBalance.class.getName());
            createCache(cm, com.alphadevs.com.domain.SupplierAccount.class.getName());
            createCache(cm, com.alphadevs.com.domain.SupplierAccountBalance.class.getName());
            createCache(cm, com.alphadevs.com.domain.PurchaseAccount.class.getName());
            createCache(cm, com.alphadevs.com.domain.PurchaseAccountBalance.class.getName());
            createCache(cm, com.alphadevs.com.domain.SalesAccount.class.getName());
            createCache(cm, com.alphadevs.com.domain.SalesAccountBalance.class.getName());
            createCache(cm, com.alphadevs.com.domain.DocumentType.class.getName());
            createCache(cm, com.alphadevs.com.domain.TransactionType.class.getName());
            createCache(cm, com.alphadevs.com.domain.Location.class.getName());
            createCache(cm, com.alphadevs.com.domain.Location.class.getName() + ".users");
            ...
            createCache(cm, com.alphadevs.com.domain.ExUser.class.getName() + ".locations");
            createCache(cm, com.alphadevs.com.domain.Stock.class.getName());
            createCache(cm, com.alphadevs.com.domain.Company.class.getName());
            createCache(cm, com.alphadevs.com.domain.ExUser.class.getName() + ".companies");
