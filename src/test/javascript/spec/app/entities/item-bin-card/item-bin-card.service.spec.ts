...
describe('Service Tests', () => {
  describe('ItemBinCard Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ItemBinCard', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            transactionDate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a ItemBinCard', async () => {
        const returnedFromService = Object.assign(
          {
            transactionDate: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of ItemBinCard', async () => {
        const returnedFromService = Object.assign(
          {
            transactionDate: currentDate.format(DATE_FORMAT),
            transactionDescription: 'BBBBBB',
      ...
      it('should delete a ItemBinCard', async () => {
